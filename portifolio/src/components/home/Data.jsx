...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Alcino Nelson
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm a passionate Software Engineer based in Maputo, focused on building scalable softwares and working with modern technologies.</p>
